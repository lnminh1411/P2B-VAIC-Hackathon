            ...
            if not os.path.exists(gz_path):
                ...
                while True:
                    ...
                    if not os.path.exists(part_name):
                        ...
                        url = f"https://raw.githubusercontent.com/lnminh1411/P2B-VAIC-Hackathon/main/backend/app/seed/cached_embeddings.json.gz.part{part_num:03d}"
                        try:
                            import urllib.request
                            print(f"Downloading split cache part from {url}...")
