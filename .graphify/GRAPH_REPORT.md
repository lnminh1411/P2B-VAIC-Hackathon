...
## Corpus Check
- Corpus is ~30,693 words - fits in a single context window. You may not need a graph.
...
Cohesion: 0.06
Nodes (12): daily_cron_worker(), dynamic_cors_middleware(), extract_document(), extract_multiple_documents(), is_allowed_origin(), Intelligent multi-document sorting and extraction agent (Goal 7), Intelligent multi-document sorting and extraction agent (Goal 7), Single file upload extraction endpoint (Goal 2) (+4 more)
...
Cohesion: 0.67
Nodes (5): clean_html_content(), fetch_document_data(), generate_xml_for_llm(), get_db_connection(), main()
...
Cohesion: 0.50
Nodes (4): Verifiable SHA-256 diff hash policy sync engine (Goal 3), Verifiable SHA-256 diff hash policy sync engine (Goal 3), Verifiable SHA-256 diff hash policy sync engine (Goal 3), sync_legal_documents()
