...
## Corpus Check
- Corpus is ~29,373 words - fits in a single context window. You may not need a graph.
...
- Included files: 41 · Candidates: 126
- Excluded: 90 untracked · 5172 ignored · 0 sensitive · 0 missing committed
- Recommendation: Use --scope all or graphify.yaml inputs.corpus for a knowledge-base folder.

## Graph Freshness
- Built from Git commit: `0e3859d`
...
Cohesion: 0.40
Nodes (3): formatDocIdForSearch(), getRobustGovLink(), translations
